...
class RSIRisingFalling(Strategy):
    ...
    def get_filter_cart_prod_array(
        ...
        # index_filter_1 = (filtered_cart_prod_array[11] >= 2000) & (filtered_cart_prod_array[11] <= 6000)

        # final_filter = index_gt & index_lt

        # filtered_cart_prod_array = filtered_cart_prod_array[:, final_filter]
